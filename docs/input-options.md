...
- `content-body-override-path`: Either `"local"` or `"remote"`. Controls whether the [changelog content body override file](./config-options.md#changelog--content-body-override-path-optional) is read from the local filesystem or remote repository.

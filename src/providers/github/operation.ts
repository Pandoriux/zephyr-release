...
import type { ProviderOperationTriggerContext } from "../../types/providers/provider-operation-context.ts";

/** @throws */
export function githubGetOperationTriggerContext(): ProviderOperationTriggerContext {

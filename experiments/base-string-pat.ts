...
import { getBaseStringPatternContext } from "../src/tasks/string-patterns/string-pattern-context.ts";
...
for (const testCase of testCases) {
  ...
  const result = getBaseStringPatternContext(mockProvider, fixedUtcDate, {
    name: testCase.name,
